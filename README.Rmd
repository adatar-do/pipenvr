...
The goal of pipenvr is to provide a compatibility layer between Python package `pipenv` and R package `reticulate`.
...
Para los fines de la función use_virtualenv() puede que el pipenv no tenga la misma estructura. En tal sentido, tomar el código de la función use_virtualenv y hacer que use_pipenv() efectue las mismas acciones.
